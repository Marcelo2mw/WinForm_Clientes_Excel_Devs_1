...
Partial Public NotInheritable Class Planilha1
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Planilha1", "Planilha1")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Planilha1 As Planilha1
    
    Friend Shared Property Planilha1() As Planilha1
        Get
            Return _Planilha1
        End Get
        Set
            If (_Planilha1 Is Nothing) Then
                _Planilha1 = value
            Else
